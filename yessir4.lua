        ...
        self.funcs = { 
                ...
                apply_desync = function()
                        if not Stranded.desync.enabled or not Stranded.desync.active then
                                -- If desync is not active but we have stored original state, restore it
                        ...
                        -- Initialize desync cache if needed
                        ...
                        -- Reset base position cache when mode changes so new mode starts fresh
                        ...
                        -- Store original state when desync first activates
